	...
	public void afterPropertiesSet () throws Exception {
		...
		if(shouldInitializeTestData && userRepository.findAll ().isEmpty ()
	  	...
	  	&& categoryRepository.findAll ().isEmpty () && locationRepository.findAll ().isEmpty ()) {
			...
			User user3 = new User ();
			user3.setEmail ( "isoft.code.io@gmail.com" );
			user3.setPassword ( encoder.encode ( "." ) );
			...
			adUser2.setEmail ( "chibuezepaul24@yahoo.com" );
			adUser2.setPassword ( encoder.encode ( "." ) );
			activeDirectoryRepo.saveAll ( Arrays.asList (adUser1, adUser2 ) );
			...
			team2.setMembers ( new HashSet<> ( Arrays.asList ( adUser2 , adUser1 ) ) );
			Team team3 = new Team ();
			team3.setName ( "Developers" );
			team3.setSupervisor ( user3 );
			team3.setMembers ( new HashSet<> ( Arrays.asList ( adUser1 , adUser2 ) ) );
